  ...
  render() {
    return (
      <Carousel
        ...
        autoPlay={true}
        interval={6100}
        className='w-full h-full flex justify-center bg-red-400 items-center'
      >
          ...
          <div className='container px-5 py-24 mx-auto'>
            <div className='xl:w-1/2 lg:w-3/4 w-full mx-auto text-center'>
              <svg
                ...
                fill='currentColor'
                className='inline-block w-8 h-8 text-red-400 mb-8'
              ...
              <p className='leading-relaxed text-lg'>
                ...
                taiyaki taxidermy 9s cronut +1 kinfolk. Single-origin coffee
              ...
              <h2 className='text-red-700 font-medium title-font tracking-wider text-sm'>
                HOLDEN CAULFIELD
              </h2>
              <p className='text-gray-900'>Senior Product Designer</p>
            </div>
          </div>
        </section>
