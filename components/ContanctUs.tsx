            ...
            <div className='w-full lg:w-6/12 px-4'>
              <div className='flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-white '>
                <div className='flex-auto p-5 lg:p-10'>
                  ...
                  <p className='leading-relaxed mt-1 mb-4 text-blueGray-500 dark:text-red-500'>
                  ...
                  <div className='text-center mt-6'>
                    <button
                      className='bg-red-500 text-white active:bg-gray-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150'
                      type='button'
                    >
                      Send Message
                    </button>
