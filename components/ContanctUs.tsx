        ...
        <div className='container mx-auto px-4'>
          <div className='flex flex-wrap justify-center lg:mt-24 mt-28'>
            <div className='w-full lg:w-6/12 px-4'>
              <div className='flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-200 dark:bg-gray-600'>
                <div className='flex-auto p-5 lg:p-10'>
                  ...
                  <div className='text-center mt-6'>
                    <button
                      className='bg-gray-700 dark:bg-gray-200 text-white dark:text-black active:bg-gray-600 text-sm font-bold uppercase px-6 py-3 rounded shadow hover:shadow-lg outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150'
                      type='button'
                    >
                      Send Message
                    </button>
