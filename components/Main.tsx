        ...
        <div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center '>
          <div className='lg:flex-grow  flex flex-col mb-16 items-center justify-center text-center'>
            ...
            <div className='flex justify-center'>
              <button className='inline-flex text-white bg-red-700 border-0 py-2 px-6 focus:outline-none hover:bg-gray-600 rounded text-lg'>
                Button
              </button>
            </div>
          </div>
          ...
          <div className='flex flex-wrap sm:-m-4 -mx-4 -mb-10 -mt-4 md:space-y-0 space-y-6'>
            <div className='p-4 md:w-1/3 flex flex-col text-center items-center'>
              ...
              <div className='flex-grow'>
                ...
                <a className='mt-3 text-red-700 inline-flex items-center font-medium'>
                  Learn More
                  <svg
                    fill='none'
                    stroke='currentColor'
